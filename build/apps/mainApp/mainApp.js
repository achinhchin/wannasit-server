        ...
        this.mainApp.post("/wannasit", (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                if (req.body.from == "client") {
                    ...
                    if (checkUser) {
                        if (req.body.for == "get") {
                            var chairsState = this.chairsState;
                ...
                if (req.body.from == "client") {
                    if (yield firebase_admin_1.default.auth().getUser(req.body.uid)) {
                        if (req.body.for == "get") {
                            ...
                            if (lastReserved != undefined && (new Date()).getTime() - (lastReserved === null || lastReserved === void 0 ? void 0 : lastReserved.getTime()) < this.projectConfig.userControl.reservedTimeRangeInMinutes * 60 * 1000) {
